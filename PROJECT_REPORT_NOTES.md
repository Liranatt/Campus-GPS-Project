...
│   │   ├── models.py             # Model architectures (ResNet18, EfficientNet, ConvNeXt)
│   │   ├── loss.py               # HaversineLoss (distance in meters)
│   │   ├── data_loader.py        # Dataset loading and preprocessing
│   │   ├── augmentation.py       # Image augmentation transforms
...
│       └── geographic_analysis*.py  # Geographic error analysis
│
├── scripts/                      # Executable scripts
│   ├── training/                 # Training experiment scripts
│   │   └── train_*.py            # Various training configurations
│   ├── comparison/               # Model comparison scripts
│   │   └── comparison_*.py       # Cross-experiment comparisons
│   └── analysis/                 # Plotting scripts
│       └── plot_*.py             # Visualization scripts
│
├── models/                       # Model storage
│   └── pretrained/               # Trained model weights (.pth files)
│
├── results/                      # All experiment results
│   ├── testing/                  # Experiment output folders
│   │   ├── 100ep_*/              # 100 epoch experiments
│   │   ├── 50ep_*/               # 50 epoch experiments
│   │   ├── 30ep_*/               # 30 epoch experiments
│   │   ├── comparison_*/         # Generated comparison plots
│   │   └── FINAL_SUMMARY.log     # Complete results summary
│   └── *.npy                     # Numpy arrays (predictions, labels, errors)
│
├── legacy/                       # Legacy and debug files
│
└── PROJECT_REPORT_NOTES.md       # This documentation file
```

---

## 12. Experiment Results Summary

### Best Results by Configuration

| Rank | Model | Experiment | Mean Error | Within 10m |
|------|-------|------------|------------|------------|
| 1 | EfficientNet | 100ep Full lr=0.001 | **5.71m** | 86.9% |
| 2 | ConvNeXt | 100ep Full lr=0.0001 | 6.12m | 85.0% |
| 3 | EfficientNet | 100ep Full lr=0.0001 | 6.25m | 83.9% |

### Key Findings

1. **Learning Rate Sensitivity**:
   - EfficientNet works best with LR=0.001
   - ConvNeXt requires LR=0.0001 (fails with higher LR: 81.82m error)

2. **Data Amount**:
   - Full data always outperforms half data
   - More training samples = better generalization

3. **Augmented Test Data**:
   - Increases test errors (as expected - harder test set)
   - Useful for measuring model robustness

4. **Epoch Count**:
   - 100 epochs generally best
   - 50 epochs sufficient for most configurations
   - 30 epochs may underfit
